...
This is a **research prototype**, not a product. It exists to show that the "who talked to a sanctioned contract" question can be answered on-chain without trusting whoever brings the evidence. It has not been audited, and the [known limitations](#known-limitations) below are real. Don't point it at real funds.

If you'd like something like this built properly, please reach out to us.
...
- Ownership is a single EOA. For real use it should be the DAO itself.
- The contract is unaudited and has never been used with real funds.
